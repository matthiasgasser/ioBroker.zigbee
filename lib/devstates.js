...
// osram switch mini
   ...
   E1744_volume_up: {
    id: 'up_button',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'rotate_right') ? true : ((payload.click === 'brightness_stop') ? false : undefined),
...
*/
    ...
    },
    {
        ...
        states: [states.E1744_volume_up, states.E1744_volume_down, states.E1744_play, states.E1744_pause, states.E1744_skip_forward, states.E1744_skip_backward],
    },                 
    {
        vendor: 'IKEA',
