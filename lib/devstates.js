...
// osram switch mini
   ...
   E1744_volume_up: {
    id: 'up_button',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.state.buttonevent == 3001) ? true : ((payload.state.buttonevent == 3003 ) ? false : undefined),
    ...
    id: 'down_button',
        ...
        read: true,
        type: 'boolean',
        getter: payload => (payload.action === 'rotate_left') ? true : ((payload.click === 'brightness_stop') ? false : undefined),
   ...
   id: 'play_button',
        ...
        read: true,
        type: 'number',
        getter: payload => (payload.click === 'commandToggle') ? true : ((payload.click === 'brightness_stop') ? false : undefined),
   ...
   E1744_pause: {
      id: 'play_button',
        ...
        read: true,
        type: 'number',
        getter: payload => (payload.click === 'commandStep') ? true : ((payload.click === 'brightness_stop') ? false : undefined),

   },
   E1744_skip_forward: {
      id: 'skip_forward_button',
        prop: 'click',
        name: 'Skip forward button pressed',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
   ...
   E1744_skip_backward: {
      id: 'skip_backward_button',
        prop: 'click',
        name: 'Skip backward button pressed',
        icon: undefined,
        role: 'button',
        write: false,
        read: true,
        type: 'boolean',
        getter: payload => (payload.click === 'skip_backward_down') ? true : ((payload.click === 'brightness_stop') ? false : undefined),
...
*/
    ...
    {
        vendor: 'IKEA',
        models: ['TRADFRI bulb GU10 WW 400lm'],
        icon: 'img/ikea_led1837r5.png',
        states: lightStates,
        linkedStates: [comb.brightnessAndState],
    },
    {
    ...
    {
        vendor: 'IKEA',
        models: ['SYMFONISK Sound Controller'], //ccccccfffebd85e0
        icon: 'img/Ikea_symfonisk_E1744.jpg',
        states: [states.battery, states.E1744_volume_up, states.E1744_volume_down, states.E1744_play, states.E1744_pause, states.E1744_skip_forward, states.E1744_skip_backward],
    },                 
    {
        vendor: 'IKEA',
